 ...
 *
 */
public class JavaLatitudeInterpretation extends AbstractJavaInterpretation {
	...
	public double matchesNumberProfileConfidence(String numberProfileName, Profile finalNumberMetrics) {
		...
		return MetricsCalculationsFacade.similarityAlgorithm1(numberProfileName, finalNumberMetrics, "Latitude", baseProfile, nameWeight);
	}
	...
	public double matchesStringProfileConfidence(String stringProfileName, Profile finalStringMetrics) {
		...
		baseProfile.setDetail(baseComparisonMetrics);
		return MetricsCalculationsFacade.similarityAlgorithm1(stringProfileName, finalStringMetrics, "Latitude", baseProfile, nameWeight);
	}
