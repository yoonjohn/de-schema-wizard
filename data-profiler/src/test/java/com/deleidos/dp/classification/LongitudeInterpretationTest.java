...
public class LongitudeInterpretationTest {
	private Logger logger = Logger.getLogger(LongitudeInterpretationTest.class);
	...
	private final String s7 = "170:00:00.0W";
	private final String s8 = "64.8";
	private final String s9 = "146.73980";
	private final String sf1 = "-180 38 38";
	private final String sf2 = "223 32 34";
	private final String sf3 = "40 1000 8";
	private final String sf4 = "100* 38 90";
	private final String sf5 = "199:00:00.0N";
	private String[] shouldPassStrings;
	private String[] shouldFailStrings;
	private final float n1 = 64.8f;
	private final float n2 = -111.8f;
	private final float nf1 = 800f;
	private final float nf2 = -211f;
	...
	public void testFitsNumberMetrics() {
		BuiltinLongitudeInterpretation latClass = new BuiltinLongitudeInterpretation();
