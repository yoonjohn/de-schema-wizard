...
This copy has been modified for Schema Wizard. It triggers the custom event
'resizeInterpretation' in order to force a resize on the content inside of
a split-pane (not the split pane itself).
		...
		setup: function(data, namespaces) {
			...
			$(this).data(SPLITPANERESIZE_HANDLER, function(event) {
				...
				if (target === parent) {
					...
					$(window).trigger('resizeInterpretation');
				}
			});
